...
TEMA : sa va luati proiectul, si sa instalati dependintele in propriul vostru mediu virtual.
Daca faceti totul ok, codul din acest fisier trebuie sa ruleze fara eroare.
"""
import requests
