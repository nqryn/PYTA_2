...
# except ValueError:
#     print('Oups, ai introdus o varsta gresita!')
#
...
"""
Putem avea mai multe blocuri de except (avem nevoie de minim unul).
Fiecare bloc trebuie sa trateze o exceptie diferita.
Blocurile trebuie sa fie in ordine, de la cea mai specifica exceptie, la cea mai generica.

Finally - bloc de cod care va fi executat MEREU, indiferent daca am avut sau nu o exceptie.
"""