"""
Context manager = o implementare care ne permite sa gestionam resurse contextul.
Exemple de resurse: fisiere, conexiuni la baza de date, conexiuni la un server, etc.
In general, aceste tipuri de resurse trebuie sa fie deschise, si mai apoi inchise.
